...
rhdeps="httpd postfix perl-DBD-Pg perl-DBD-MySQL quota iptables openssl python mysql mysql-server mysql-devel logrotate webalizer mod_perl mod_python cyrus-sasl cyrus-sasl-gssapi mod_ssl perl-XML-Simple perl-Crypt-SSLeay mlocate"
